<template>
  ...
  <div class="modal-footer">
    <button type="button" class="btn btn-dark" data-bs-dismiss="modal">OK</button>
      ...
      <img class="col-lg-5 align-items-stretch order-1 order-lg-2 img" id="dlemonie" src="../../static/img/rincian/produk-dlemonie.png" data-aos="zoom-in" data-aos-delay="150" alt="Gambar">
  </div>
</div> 
<br/><br/>
