...
<div class="modal fade" id="manfaatsunscreensansuyu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    ...
    <div class="modal-footer">
      ...
      <img class="col-lg-5 align-items-stretch order-1 order-lg-2 img" id="sunscreensansuyu" src="../../static/img/rincian/sunscreensansuyu.png" data-aos="zoom-in" data-aos-delay="150" alt="Gambar">
      </div>
      </div>
      <br/><br/>
    <div class="container garis-panjang"></div>
...
<div class="modal fade" id="manfaatcreambrightening" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    ...
    <div class="modal-footer">
      ...
      <img class="col-lg-5 align-items-stretch order-1 order-lg-2 img" id="creambrightening" src="../../static/img/rincian/creambrightening.png" data-aos="zoom-in" data-aos-delay="150" alt="Gambar">
      </div>
    </div><br/><br/>
