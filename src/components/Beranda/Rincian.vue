...
<div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("/img/rincian/produk-dlemonie.png");' data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>    </div>
  </div><br/><br/>
