<template>
  ...
  <div class="modal-footer">
    <button type="button" class="btn btn-dark" data-bs-dismiss="modal">OK</button>
      ...
      <img class="col-lg-5 align-items-stretch order-1 order-lg-2 img" id="dlemonie" src="/img/rincian/dlemonie.png" data-aos="zoom-in" data-aos-delay="150" alt="Gambar">
  </div>
</div> 
<br/><br/>
...
<div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalScrollable">Manfaat Magic Soap</h5>
    <button type="button" class="btn close" data-bs-dismiss="modal" aria-label="Close">
      <span aria-hidden="true">&times;</span>
    </button>
  </div>
  ...
  <div class="modal-footer">
    <button type="button" class="btn btn-dark" data-bs-dismiss="modal">OK</button>
      ...
      <img class="col-lg-5 align-items-stretch order-1 order-lg-2 img" id="magicsoap" src="../../static/img/rincian/magicsoap.png" data-aos="zoom-in" data-aos-delay="150" alt="Gambar">
    </div>
  </div><br/><br/>
      ...
      <div id="carouselMagicsoap" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="row">
              <div class="col-md-4">
                <img src="../../static/img/testimoni/magicsoap/magicsoap1.jpg" class="d-block w-100 testimonial-img" alt="...">
              </div>
              <div class="col-md-4">
                <img src="../../static/img/testimoni/magicsoap/magicsoap2.jpg" class="d-block w-100 testimonial-img" alt="...">
              </div>

              <div class="col-md-4">
                <img src="../../static/img/testimoni/magicsoap/magicsoap3.jpg" class="d-block w-100 testimonial-img" alt="...">
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item">
            <div class="row">
              <div class="col-md-4">
                <img src="../../static/img/testimoni/magicsoap/magicsoap4.jpg" class="d-block w-100 testimonial-img" alt="...">
              </div>
              <div class="col-md-4">
                <img src="../../static/img/testimoni/magicsoap/magicsoap5.jpg" class="d-block w-100 testimonial-img" alt="...">
              </div>

              <div class="col-md-4">
                <img src="../../static/img/testimoni/magicsoap/magicsoap6.jpeg" class="d-block w-100 testimonial-img" alt="...">
              </div>
            </div>
          </div>
        </div>
...
<div class="modal-dialog modal-dialog-scrollable" role="document">
  ...
  <div class="modal-footer">
    <button type="button" class="btn btn-dark" data-bs-dismiss="modal">OK</button>
      ...
      <img class="col-lg-5 align-items-stretch order-1 order-lg-2 img" id="jellyserum" src="../../static/img/rincian/jellyserum.png" data-aos="zoom-in" data-aos-delay="150" alt="Gambar">
    </div>
  </div><br/><br/>
      ...
      <div id="carouselJellyserum" class="carousel slide" data-bs-ride="carousel"
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="row">
              <div class="col-md-4">
                <img src="../../static/img/testimoni/jellyserum/jellyserum1.png" class="d-block w-100 testimonial-img" alt="...">
              </div>

              <div class="col-md-4">
                <img src="../../static/img/testimoni/jellyserum/jellyserum2.png" class="d-block w-100 testimonial-img" alt="...">
              </div>
            </div>
          </div>
        </div>
