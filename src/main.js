...
var imgElement = document.getElementById('lemonieskin-glowing');
var imgElement = document.getElementById('lemonieskin-acne');
var imgElement = document.getElementById('lemonieskin-flek');
var imgElement = document.getElementById('lemonieglow-glowing');
var imgElement = document.getElementById('lemonieglow-acne');
var imgElement = document.getElementById('lemonieglow-flek');
...
var lemonieskinGlowingImg = document.getElementById('lemonieskin-glowing');
var lemonieskinAcneImg = document.getElementById('lemonieskin-acne');
var lemonieskinFlekImg = document.getElementById('lemonieskin-flek');
var lemonieglowGlowingImg = document.getElementById('lemonieglow-glowing');
var lemonieglowAcneImg = document.getElementById('lemonieglow-acne');
var lemonieglowFlekImg = document.getElementById('lemonieglow-flek');
...
var lemonieskinGlowingUrl = lemonieskinGlowingImg.getAttribute('src');
var lemonieskinAcneUrl = lemonieskinAcneImg.getAttribute('src');
var lemonieskinFlekUrl = lemonieskinFlekImg.getAttribute('src');
var lemonieglowGlowingUrl = lemonieglowGlowingImg.getAttribute('src');
var lemonieglowAcneUrl = lemonieglowAcneImg.getAttribute('src');
var lemonieglowFlekUrl = lemonieglowFlekImg.getAttribute('src');
...
console.log(lemonieskinGlowingUrl);
console.log(lemonieskinAcneUrl);
console.log(lemonieskinFlekUrl);
console.log(lemonieglowGlowingUrl);
console.log(lemonieglowAcneUrl);
console.log(lemonieglowFlekUrl);
